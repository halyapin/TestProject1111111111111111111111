...
namespace TestShluz1.PageObjectModel
{
    ...
    internal class SmevPageShluz
    {
        ...
        public IWebElement smevTemplatesField => _driver.FindElement(By.XPath("//a[@href ='/smev/settings/templates']"));
        ...
        public IWebElement smevLogsField => _driver.FindElement(By.XPath("//a[@href ='/smev/logs']"));


        //jobs

        public IWebElement smevJobsField => _driver.FindElement(By.XPath("//a[@href ='/smev/jobs']"));
